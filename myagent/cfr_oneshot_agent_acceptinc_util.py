...
class CFROneShotAgent(OneShotAgent):
    ...
    def init(self):
        policy_path = pathlib.Path(__file__).with_name("cfr_oneshot_agent_acceptinc_util.policy.json")
...
# python3 cfr_oneshot_agent_acceptinc_util.py --train --iters 300000 --save_interval 300000 --out_pattern "cfr_oneshot_agent_acceptinc_util_iter_{}.policy.json" --out "cfr_oneshot_agent_higherbeta.policy.json"